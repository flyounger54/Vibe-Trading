...
class TestBarsPerYear:
    ...
    def test_minute_astock(self) -> None:
        assert calc_bars_per_year("1m", "astock") == 252 * 240

    def test_minute_global(self) -> None:
        assert calc_bars_per_year("1m", "global") == 252 * 390
