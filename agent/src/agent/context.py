...
def _bundled_preset_count() -> int:
    """Discover the shipped swarm preset count instead of maintaining a literal."""
...
_SYSTEM_PROMPT = """You are a finance research agent with {skill_count} specialist skills, {tool_count} tools, 7 data sources (with auto-fallback), and {preset_count} multi-agent swarm teams.
...
class ContextBuilder:
    ...
    def build_system_prompt(self, user_message: str = "") -> str:
        ...
        return _SYSTEM_PROMPT.format(
            ...
            preset_count=_bundled_preset_count(),
